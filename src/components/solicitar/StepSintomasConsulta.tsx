...
const StepSintomasConsulta = ({ formData, updateForm, errors }: Props) => {
      ...
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Selecione os sintomas que você está sentindo para que o médico possa avaliar.
          </p>
        </div>
      </div>
...
export default StepSintomasConsulta;
