...
/** Official Google "G" logo in its real brand colors. */
export const GoogleLogo = ({ size = 20, className }: GoogleLogoProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 48 48"
  ...
  >
    ...
    <path
      fill="#1976D2"
      d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.2-4.2 5.6l6.2 5.2C40.9 35.9 44 30.4 44 24c0-1.3-.1-2.4-.4-3.5z"
    />
  </svg>
);
